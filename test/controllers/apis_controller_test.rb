...
class ApisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api" do
    assert_difference("Api.count") do
      post apis_url, params: { api: { automationpage_id: @api.automationpage_id, description: @api.description, link: @api.link, name: @api.name } }
    end
  ...
  test "should update api" do
    patch api_url(@api), params: { api: { automationpage_id: @api.automationpage_id, description: @api.description, link: @api.link, name: @api.name } }
