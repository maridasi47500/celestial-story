...
class LlmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create llm" do
    assert_difference("Llm.count") do
      post llms_url, params: { llm: { link: @llm.link, llmpage_id: @llm.llmpage_id, name: @llm.name } }
    end
  ...
  test "should update llm" do
    patch llm_url(@llm), params: { llm: { link: @llm.link, llmpage_id: @llm.llmpage_id, name: @llm.name } }
